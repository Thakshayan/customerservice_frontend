                                    ...
                                    <div className="card yearly-sales">
                                        <div className="card-block" style={{padding:'10px 30px 0px 35px'}}>
                                            ...
                                            <div style={{ margin:'15px',display:'flex'}}>
                                                <a href={"/Customer/CustomerSPReview/"+ID} className="btn btn-primary" style={{width:'100%',height:'25px',padding:'0px 0px',background:'#5e8d25',borderColor:'#5e8d25'}}>
                                                    
                                                    Review 
                                                </a>
                                                <a href={"/Customer/scheduleWork/"+ID} className="btn btn-primary" style={{width:'100%',height:'25px',padding:'0px 0px',background:'#038fcf'}}>
                                                    Schedule Work
