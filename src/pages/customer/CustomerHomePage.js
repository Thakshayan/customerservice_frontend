            ...
            <div className="collapse navbar-collapse">
                <ul className="navbar-nav mr-auto">
                    ...
                    <li className="nav-item dropdown">
                        <a className="dropdown-toggle" href="#0" data-toggle="dropdown" >{province}</a>
                        <ul className="dropdown-menu">
                            {provinces.showDistricts.map(Province=>(
                               <li><a className="dropdown-item" href="#0" onClick={()=>setProvince(Province.districtName)}>{Province.districtName}</a></li>
                            ))}
                        </ul>
                    </li>
                ...
                <ul className="navbar-nav ml-auto">
                    <li className="nav-item dropdown">
                        <a className="dropdown-toggle" href="#0" data-toggle="dropdown">{service}</a>
                        <ul className="dropdown-menu">
                            {services.data.getServices.map(service=>(
                                <li><a className="dropdown-item" href="#0" onClick={()=>setService(service.service_name)}>{service.service_name}</a></li>
                            ))}
                            </ul>
                    </li>
                    {/* <li className="nav-item dropdown">
                        <a className="dropdown-toggle" href="#0" data-toggle="dropdown">{Filter}</a>
                        <ul className="dropdown-menu">
                            <li><a className="dropdown-item" href="#0" onClick={()=>setFilter("Gold Service Providers")}>Gold Service Providers</a></li>
                            <li><a className="dropdown-item" href="#0" onClick={()=>setFilter("Platinum Service Providers")}>Platinum Service Providers</a></li>
                            <li><a className="dropdown-item" href="#0" onClick={()=>setFilter("All Service Providers")}>All Service Providers</a></li>
                        </ul>
                    </li> */}
                    <li>
