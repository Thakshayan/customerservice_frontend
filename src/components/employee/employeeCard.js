        ...
        {content ?<div className="card-container ">
            <div className="card-employee">
                <div className="bg">
                    ...
                    {content.left_date ?
                        <div style={{textAlign:'center'}} >
                            <div className="tooltips" id="tooltips">
                                <i className="fas fa-circle text-c-red f-10 m-r-15" style={{marginLeft:10}}></i>
                                <span className="tooltiptext" >Left Work</span>
                            </div> 
                        </div>:
                        <div >
                            
                            <div className="tooltips">
                                <i className="fas fa-circle text-c-green f-10 m-r-15" style={{marginLeft:10}}></i>
                                <span className="tooltiptext" >Still Working</span>
                            </div>
                        </div>
                        }
                    {/* <a href="/CSA/edit/basicInfo"><i className="fa fa-cog" title="Edit" aria-label="edit"></i></a> */}
                    </div>
                    ...
                    <a href={type==="Moderator"?`/CSA/moderatorProfile/${content._id}`:`/CSA/profile/${content._id}`} className="btn-follow" aria-label="view more">
                        View More &nbsp;
