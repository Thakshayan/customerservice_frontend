                        ...
                        <div className="dropdown">
                            ...
                            <div className="dropdown-menu dropdown-menu-right notification">
                                ...
                                <div className="noti-footer">
                                    <a href="/CSA/notifications">show all notifications</a>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div className="dropdown drp-user">
                            ...
                            <div className="dropdown-menu dropdown-menu-right profile-notification">
                                ...
                                <ul className="pro-body">
                                    ...
                                    <li><a href={type == "moderator" ?`/CSA/moderatorProfile/${id}`:`/CSA/profile`} className="dropdown-item"><i className="feather icon-user"></i> My Profile</a></li>
                                    <li><a href={"/CSA/messages"} className="dropdown-item"><i className="feather icon-mail"></i> Messages</a></li>
